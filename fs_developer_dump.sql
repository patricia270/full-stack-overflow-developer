...
COPY public.answers (id, question_id, answered_by, answer, answered_at) FROM stdin;
\.
...
COPY public.questions (id, question, student, class, tags, answered, submit_at, score) FROM stdin;
\.
